...
INT_WIFI="wlxd03745198010" # wifi access point interface
INT_NET="enp0s3" # interface connected to internet
...
sudo hostapd /home/rohirrim/Documentos/secmob/wifislayer/fakeap/conf/hostapd.conf &
sleep 1


echo -e "Starting daemon dnsmasq... "
# start dnsmasq server (see dnsmasq.conf) -7 /etc/dnsmasq.d
sudo dnsmasq -x /var/run/dnsmasq.pid -C /home/rohirrim/Documentos/secmob/wifislayer/fakeap/conf/dnsmasq.conf
sleep 1
...
sudo dhcpd  -f -pf /var/run/dhcp-server/dhcpd.pid -cf /home/rohirrim/Documentos/secmob/wifislayer/fakeap/conf/dhcpd.conf $INT_WIFI &
